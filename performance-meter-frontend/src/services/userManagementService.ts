...
// Gebruik directe endpoints zonder authenticatie voor debugging
const USE_DIRECT_ENDPOINTS = true;
const BASE_PATH = USE_DIRECT_ENDPOINTS ? '/api/user-management-direct' : '/api/user-management';
